                        ...
                        <div>
                            ...
                            <textarea id="content" name="content" rows="10"
                                      ...
                                      class="w-full px-4 py-2.5 border border-slate-300 rounded-xl text-sm text-slate-800 placeholder-slate-400
                                             ...
                                             @error('content') border-rose-400 bg-rose-50 @enderror">{{ old('content') }}</textarea>
                            @error('content')
                        ...
                        <div>
                            ...
                            <textarea id="meta_description" name="meta_description" rows="3"
                                      ...
                                      class="w-full px-4 py-2.5 border border-slate-300 rounded-xl text-sm text-slate-800 placeholder-slate-400
                                             ...
                                             @error('meta_description') border-rose-400 bg-rose-50 @enderror">{{ old('meta_description') }}</textarea>
